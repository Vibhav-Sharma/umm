# ============================================
# Mini Project: Support Vector Machine (SVM)
# ============================================
...
np.random.seed(42)
n = 200
X1 = np.concatenate([np.random.normal(3, 1, n // 2), np.random.normal(7, 1, n // 2)])
...
plt.scatter(X_test['Feature_1'], X_test['Feature_2'], c=y_test, cmap='coolwarm', edgecolors='k', alpha=0.7)
